    ...
    <section
        ...
        <div className="flex flex-col items-start flex-1.5">
            ...
            <p className="text-light font-poppins font-normal sm:leading-[26px] leading-[20px]text-[18px] max-w-[594px]">
                Metawork is a reference super app for all kinds of services, and
                it was created to quickly meet your needs, and you can solve
                your daily or specialized needs by communicating directly with
                the best and closest service providers, and you can get all...
            </p>
